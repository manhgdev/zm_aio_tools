/** Icon SVG nội bộ của TTS Studio (icon dùng toàn app đặt ở shared/components/Icons). */
...
export function IconClone({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function IconPaste({ size = 12 }: { size?: number }) {
  return (
...
export function IconKb({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
