...
export const BASE_VIETNAM_2D_IMAGE_PROMPT = `ZMTOOL AUDIO-FIRST VIDEO PRODUCTION ENGINE V1.0
...
export const BASE_ENGLISH_2D_IMAGE_PROMPT = `ZMTOOL AUDIO-FIRST VIDEO PRODUCTION ENGINE V1.0
...
export const FLOW_PROMPT_TEMPLATES: FlowPromptTemplate[] = [
  {
    id: 'base-vn-2d-image',
    title: {
  ...
  },
  {
    id: 'base-en-2d-image',
    title: {
      vi: 'ZMTOOL Audio-First 2D Engine V1.0 (Bản Tiếng Anh)',
      en: 'ZMTOOL Audio-First 2D Engine V1.0 (English Base)',
    },
    type: 'system_prompt',
    category: 'image',
    lang: 'en',
    version: 'v1.0',
    description: {
      vi: 'Bộ System Prompt tiếng Anh chuẩn cho thị trường quốc tế, phân tích SRT/Audio tiếng Anh để AI xuất danh sách prompt hình ảnh 2D tối ưu hóa cho công cụ tạo ảnh AI.',
      en: 'Standard English System Prompt for international markets, analyzing English SRT/Audio into AI-optimized 2D illustration prompt sequences.',
    },
    filename: 'v1.0-base-english-2D-image.txt',
    tags: ['System Prompt Engine', 'SRT Analysis', '2D Illustration', 'Audio-First', 'English Base', 'Global YouTube'],
    content: BASE_ENGLISH_2D_IMAGE_PROMPT,
  },
]
