  ...
  return <main className="srt-export-page">
    ...
    <section className="srt-export-card">
      ...
      <div className="srt-export-body">
        ...
        <OutputFolderField isDesktopApp={isDesktopApp} value={outputDir} onChange={setOutputDir} onChoose={() => pickOutputDir().catch((e) => setError(e instanceof Error ? e.message : String(e)))} onSave={() => localStorage.setItem(OUTPUT_DIR_KEY, outputDir)} defaultPath={t('Mặc định: Downloads/ZM_AIO_TOOL/subtitles/export', 'Default: Downloads/ZM_AIO_TOOL/subtitles/export')} />
      </div>
