    ...
    <main className="drawing-page">
      ...
      <div className="drawing-grid">
        <section className="drawing-card drawing-input-card">
          ...
          <OutputFolderField isDesktopApp={isDesktopApp} value={outputDir} onChange={setOutputDir} onChoose={() => pickOutputDir().catch(() => undefined)} onSave={() => window.localStorage.setItem(DRAWING_OUTPUT_DIR_KEY, outputDir)} defaultPath={t('Mặc định: Downloads/ZM_AIO_TOOL/drawing', 'Default: Downloads/ZM_AIO_TOOL/drawing')} />
