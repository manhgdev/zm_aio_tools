        ...
        <div className="vc-grid">
          ...
          <div className="vc-col">
            ...
            <div className="vc-card">
              ...
              <div style={{ marginTop: 14 }}><OutputFolderField isDesktopApp={isDesktopApp} value={outputDir} onChange={setOutputDir} onChoose={() => pickOutputDir().catch((error) => alert(error instanceof Error ? error.message : String(error)))} onSave={() => localStorage.setItem(LS_VC_OUTPUT_DIR, outputDir)} defaultPath={t('Mặc định: Downloads/ZM_AIO_TOOL/cleaner', 'Default: Downloads/ZM_AIO_TOOL/cleaner')} /></div>
            </div>
